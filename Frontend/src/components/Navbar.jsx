  ...
  return (
    <header ref={ref} className="nav">
      <div className="nav-inner">
        {/* Left section: Stacked Logo on Desktop (hidden on mobile/tablet) */}
        ...
        {/* Center section: Emblem on Desktop, Emblem + Stacked Name/Subtext on Mobile/Tablet */}
        <div className="nav-center">
          <a href="/" className="nav-center-logo" style={{ color: 'inherit' }}>
            <svg width="45" height="35" viewBox="0 0 88 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="nav-emblem-svg">
              {/* Slanted L */}
            ...
            <div className="nav-center-brand-mobile">
              <span className="nav-brand-title">NISARG <strong>DARJI</strong></span>
              <span className="nav-brand-sub">CREATIVE WEB DEVELOPER</span>
            </div>
          </a>
        </div>

        {/* Right section: STORE Button (moves to top-left on mobile) + Menu Button */}
        <div className="nav-right">
          <a href="https://store.landonorris.com/" target="_blank" rel="noopener noreferrer" className="btn-w is-nav nav-store-btn">
